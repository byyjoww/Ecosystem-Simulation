...
[CustomEditor(typeof(AppInitializer))]
public class AppInitializerEditor : Editor
{
    private SerializedProperty m_initializebles;
    private ReorderableList m_ReorderableList;

    private void OnEnable()
    {
        //Find the list in our ScriptableObject script.
        m_initializebles = serializedObject.FindProperty("initializebles");
    ...
    {
        EditorGUI.LabelField(rect, "Initializables");
    }
    ...
    private void DrawElementCallback(Rect rect, int index, bool isactive, bool isfocused)
    {
        ...
        EditorGUI.PropertyField(position:
            ...
            element, label: new GUIContent("Element"), includeChildren: true);
    }
